...
\begin{itemize}
	...
	\item
	Il posizionamento delle operazioni preliminari al salvataggio dei dati è indifferente se sia nelle \emph{Actions} o nelle \emph{Stores} e può essere svolto prima o dopo l'operazione di \emph{dispatch} di \emph{Alt}, perché come spiegato nel punto precedente \emph{Actions} e \emph{Stores}
\end{itemize}