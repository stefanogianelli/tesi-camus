...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{2-preliminari/Immagini/esempio_cdt.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{2-preliminari/Immagini/configuration-based-mapping.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{2-preliminari/Immagini/value-based-mapping.png}
...
In questa sezione si vuole fornire una panoramica sulle tecnologie che sono state utilizzate per lo sviluppo del backend. Verrà analizzato per prima il framework Node.js, con il quale è stata sviluppata la logica del backend. In seguito verranno descritti i due sistemi di gestione di database utilizzati: MongoDB, per la persistenza dei dati, e Redis, per la gestione della cache.
