...
\input{2-preliminari/preliminari.tex}


\chapter{Metodologia CAMUS\label{ch:camus}}

\input{3-metodologia-camus/metodologia-camus.tex}


\chapter{Progettazione di alto livello\label{ch:metodologia}}

\input{4-progettazione-alto-livello/progettazione.tex}
...
\input{appendice-descrittori/descrittori.tex}

\chapter{Esempi di codice\label{app:appendice-esempi}}

\input{appendice-esempi/esempi-codice.tex}
