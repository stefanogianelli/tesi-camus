...
\upe proprio per cercare nuovi strumenti in grado di migliorare l'esperienza dell'u\-ten\-te nell'esplorazione delle informazioni che nasce il progetto CAMUS. CAMUS è l'a\-cro\-ni\-mo di \virgolette{Context Aware Mobile mashUpS} e proprio dalla sigla si possono intuire le due anime principali che sono alla base del progetto: il \emph{contesto} e i \emph{mashup}.
...
\textcolor{red}{dici di rendere gli attori in modo schematico?}
