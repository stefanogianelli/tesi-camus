...
\upe proprio per cercare nuovi strumenti in grado di migliorare l'esperienza dell'u\-ten\-te nell'esplorazione delle informazioni che nasce il progetto CAMUS. CAMUS è l'a\-cro\-ni\-mo di \virgolette{Context Aware Mobile mashUpS} e proprio dalla sigla si può intuire come la sua anima sia fortemente legata al voler mettere in primo piano il \emph{contesto} dell'utente, soprattutto quando è in mobilità e necessita di informazioni accurate e precise.
