...
\begin{itemize}
	\item \textbf{Top-down} Si può usare un approccio di tipo top-down quando si vuole usare lo \emph{Swagger Editor} \textcolor{red}{(Immagine o reference)} per creare la definizione del servizio e successivamente generare l'applicazione server con lo strumento \emph{Swagger Codegen}
...
Appery.io è un sito web che ha due funzionalità principali: la costruzione di applicazioni mobile in maniera rapida e l'offerta di un servizio di Mobile Backend as a service (MBaaS).
...
\textcolor{red}{Aggiungere citazioni ed eventualmente esempi}
...
\textcolor{red}{Aggiungere esempi di Peudom e immagini}
...
\textcolor{red}{esempio film adapt}
...
\textcolor{red}{(immagine CADD tool architecture)}
I componenti di CADD spiegati in \textcolor{red}{(immagine cadd)} sono i seguenti:
\begin{itemize}
	\item \textbf{Context Space Designer Assistant} Il designer è guidato nella modifica del CDT usando una procedura guidata 
