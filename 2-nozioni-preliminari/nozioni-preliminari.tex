...
\begin{itemize}
	...
	\item \textbf{Sviluppo}
	La costruzione delle applicazioni è svolta in modo modulare, con componenti riutilizzabili in maniera veloce e semplice. Possono essere già presenti oppure creati da zero. Il tipo di struttura dati utilizzato, invece, è di tipo model-based, in particolare si è usato il pattern MVC (Model View Controller). Anche per quanto riguarda lo storage dei dati la soluzione scelta è di tipo visuale, con la Storage API, che permette di gestire le variabili.
...
\textcolor{red}{Aggiungere esempi di Karma ed immagini}
