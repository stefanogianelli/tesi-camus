...
Solitamente ad una URI può essere associata una funzione diversa in base al verbo con la quale viene invocata, come si può notare nell'esempio in Tabella ???

\textcolor{red}{da completare}

\begin{tabular}{c c c c c}
	Risorsa & GET & PUT & POST & DELETE\\
	http://api.example.com/resources/ & List & Replace & Create & Delete\\
	http://api.example.com/resources/item17 & Retrieve & Replace & Create? & Delete
\end{tabular}
