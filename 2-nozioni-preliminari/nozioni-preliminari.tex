...
\begin{center}
	...
	\begin{minipage}[t]{0.63\textwidth}
		\lstinputlisting[caption=Esempio di connessione GraphQL,
			label=lst:esempio-connessione-graphql]{2-nozioni-preliminari/Codice/esempio_connessione_graphql.graphql}
	\end{minipage}%
	\begin{minipage}[t]{0.63\textwidth}
		\lstinputlisting[caption=Esempio di risposta,
			label=lst:esempio-risposta-connessione-graphql,style=json]{2-nozioni-preliminari/Codice/esempio_risposta_connessione_graphql.json}
	\end{minipage}	
\end{center}
