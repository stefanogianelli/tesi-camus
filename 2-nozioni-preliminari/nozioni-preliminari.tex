...
\begin{enumerate}
	...
	\begin{itemize}
		...
		Una API permette al creazione permette di creare un mashup basato sul web fornendo un mezzo per avere accesso a una applicazione o a un contenuto (es.: Google Maps), solo per un software compatibile.
...
\begin{itemize}
		\item \textbf{Ease of use} L'utente, utilizzando tecniche di programmazione per esempi e algoritmi  di ottimizzazione (es.: Steiner tree), perfeziona il modello generato in modo automatico utilizzando un interfaccia grafica e non vede mai la complessità delle regole di mapping usate
