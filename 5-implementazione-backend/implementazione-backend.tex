...
\textcolor{red}{algoritmo di selezione dei nodi figlio}
...
\subsection{Execution Helper\label{sec:execution-helper}}

\textcolor{red}{definire le pipeline di esecuzione}

\subsection{Query Composer\label{sec:query-composer}}

\textcolor{red}{parlare del query composer, da chi viene utilizzato e pseudocodice algoritmo}
