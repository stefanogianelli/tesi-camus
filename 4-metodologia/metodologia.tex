...
Per l'acquisizione dei dati è importante che il server sappia come interrogare i servizi e come interpretare le risposte. Si è deciso dunque di mantenere una repository dei servizi che il sistema può utilizzare.

Questa repository è composta dai \emph{descrittori dei servizi}, che contengono le informazioni necessarie per interrogare i servizi. In particolare, sono composti dalle seguenti sezioni:

\begin{itemize}
	\item \emph{Elenco dei parametri} In questa sezione vengono elencati i parametri necessari per la composizione della query di ricerca. I valori possono essere acquisiti secondo 3 differenti modalità:
	\begin{enumerate}
